    ...
    public class RestoreRunnerTests
    {
        ...
        public async Task RestoreRunner_BasicRestore_VerifyFailureWritesFiles_NETCoreAsync()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                spec1.TargetFrameworks[0] = spec1.TargetFrameworks.Single().WithTargetAlias("net45");
...
";
        ...
        public async Task RestoreRunner_RestoreWithExternalFileAsync()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                spec1.TargetFrameworks[0] = spec1.TargetFrameworks[0].WithDependencies(spec1TargetFrameworkDependencies);
