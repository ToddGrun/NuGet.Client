...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        public class PackageSpecModify
        {
            ...
            public static void ModifyOriginalTargetFrameworkInformationEdit(PackageSpec packageSpec)
            {
                ...
                packageSpec.TargetFrameworks[0] = packageSpec.TargetFrameworks[0].WithImports(newImports);
            }
        ...
        public void TargetFrameworkInformationCloneTest()
        {
            ...
            // Act
            originalTargetFrameworkInformation = originalTargetFrameworkInformation.WithImports([]);
            ...
            // Act
            originalTargetFrameworkInformation = originalTargetFrameworkInformation.WithDependencies([]);
            ...
            // Act
            originalTargetFrameworkInformation = originalTargetFrameworkInformation.WithDownloadDependencies([]);
            ...
            //Setup
            var cloneToTestFrameworkReferenceEquality = originalTargetFrameworkInformation.WithFrameworkReferences([
                new FrameworkDependency("frameworkRef", FrameworkDependencyFlags.All),
                new FrameworkDependency("frameworkReference", FrameworkDependencyFlags.None)
            ]);
            ...
            // Act
            originalTargetFrameworkInformation = originalTargetFrameworkInformation.WithFrameworkReferences([]);
            ...
            // Act
            originalTargetFrameworkInformation = originalTargetFrameworkInformation.WithRuntimeIdentifierGraphPath("new/path/to/runtime.json");
